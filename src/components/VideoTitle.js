...
const VideoTitle = ({ title, description }) => {
  ...
  return (
    <div className="w-screen aspect-video pt-[25%] md:pt-[20%] px-2 md:px-12 lg:px-20 absolute text-white bg-gradient-to-r from-black">
      ...
      <div className="flex px-0  py-2 md:p-0 md:pt-2">
